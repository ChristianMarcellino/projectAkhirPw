...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Form\Button::resolve(['label' => 'Tambah Proyek','theme' => 'success','icon' => 'fas fa-plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-3','onclick' => 'window.location=\''.e(route('proyek.create')).'\'']); ?>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Widget\Card::resolve(['title' => 'Daftar Proyek','theme' => 'info','icon' => 'fas fa-list'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $proyek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($item->no_pbg); ?></td>
                            <td><?php echo e($item->nama_proyek); ?></td>
                            <td><?php echo e($item->jumlah_unit); ?></td>
                            <td>Rp<?php echo e(number_format($item->harga_rumah, 0, ',', '.')); ?></td>
                            <td><?php echo e($item->luas_tanah); ?> m²</td>
                            <td>Rp<?php echo e(number_format($item->harga_kelebihan_tanah, 0, ',', '.')); ?></td>
                            <td><?php echo e($item->alamat); ?></tdf>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-only')): ?>
                            <td>
...
<?php $attributes = $attributes->except(\JeroenNoten\LaravelAdminLte\View\Components\Form\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','title' => 'Edit','class' => 'rounded','onclick' => 'window.location=\''.e(route('proyek.edit', $item->id)).'\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal84b78d66d5203b43b9d8c22236838526)): ?>
<?php $attributes = $__attributesOriginal84b78d66d5203b43b9d8c22236838526; ?>
...
<?php endif; ?>
                                    ...
                                    <form action="<?php echo e(route('proyek.destroy', $item->id)); ?>" method="POST" class="d-inline">
...
<?php $attributes = $attributes->except(\JeroenNoten\LaravelAdminLte\View\Components\Form\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'show_confirm rounded','data-nama' => 'Proyek '.e($item->nama_proyek).'','size' => 'sm','title' => 'Hapus']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal84b78d66d5203b43b9d8c22236838526)): ?>
<?php $attributes = $__attributesOriginal84b78d66d5203b43b9d8c22236838526; ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemula\projectAkhirPw\resources\views/proyek/index.blade.php ENDPATH**/ ?>