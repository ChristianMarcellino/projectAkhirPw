...
<?php endif; ?>
            ...
            <div class="flex flex-col sm:flex-row justify-between items-center mt-4 gap-3">
                <?php if(Route::has('password.request')): ?>
                    <a class="text-sm text-indigo-600 hover:underline" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
            ...
            <div class="text-center mt-6">
                <span class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-indigo-600 hover:underline">
...
<?php endif; ?><?php /**PATH E:\Pemula\projectAkhirPw\resources\views/auth/login.blade.php ENDPATH**/ ?>