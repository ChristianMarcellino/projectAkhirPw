<?php $__env->startSection('title', 'Data Bi Checking'); ?>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Form\Button::resolve(['label' => 'Tambah Bi Checking','theme' => 'success','icon' => 'fas fa-plus'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-3','onclick' => 'window.location=\''.e(route('bi_checking.create')).'\'']); ?>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Widget\Card::resolve(['title' => 'Daftar Bi Checking','theme' => 'info','icon' => 'fas fa-list'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        <div class="table-responsive">
            <table class="table table-bordered table-hover table-striped w-100">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $biChecking; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><?php echo e($loop->iteration); ?></td>
                            <td><?php echo e($item->id_checking); ?></td>
                            <td><?php echo e($item->konsumen->nama_konsumen ?? '-'); ?></td>
                            <td><?php echo e($item->hasil_checking); ?></td>
                            <td><?php echo e($item->tanggal_checking); ?></tdf>
                           <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin-only')): ?>
                           <td>
...
<?php $attributes = $attributes->except(\JeroenNoten\LaravelAdminLte\View\Components\Form\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'sm','title' => 'Edit','class' => 'rounded','onclick' => 'window.location=\''.e(route('bi_checking.edit', $item->id)).'\'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal84b78d66d5203b43b9d8c22236838526)): ?>
<?php $attributes = $__attributesOriginal84b78d66d5203b43b9d8c22236838526; ?>
...
<?php endif; ?>
                                ...
                                <form action="<?php echo e(route('bi_checking.destroy', $item->id)); ?>" method="POST" class="d-inline">
...
<?php $attributes = $attributes->except(\JeroenNoten\LaravelAdminLte\View\Components\Form\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'show_confirm rounded','data-nama' => 'BI Checking '.e($item->konsumen->nama_konsumen).'','size' => 'sm','title' => 'Hapus']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal84b78d66d5203b43b9d8c22236838526)): ?>
<?php $attributes = $__attributesOriginal84b78d66d5203b43b9d8c22236838526; ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\Pemula\projectAkhirPw\resources\views/bi_checking/index.blade.php ENDPATH**/ ?>