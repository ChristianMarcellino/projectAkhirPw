            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="no_shm_rumah" class="form-control @error('no_shm_rumah') is-invalid @enderror" value="{{ old('no_shm_rumah') }}" maxlength="18">
                        @error('no_shm_rumah')
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="harga_dp" class="form-control @error('harga_dp') is-invalid @enderror" value="{{ old('harga_dp') }}">
                        @error('harga_dp')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
